...
let colors = ['red','green', 'blue', 'gold','pink']; //untuk pieplot
...
let dataSheet;
let urlAPI = "https://api.openweathermap.org/data/2.5/weather?q=Lampung&appid=64792419a42a970a29a7a68ed82ab422&units=metric";
let dataAPI;
